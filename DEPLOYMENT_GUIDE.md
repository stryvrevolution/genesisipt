# 🚀 Guide de Déploiement sur stryvlab.com
...
Tu as déjà un projet Vercel lié (`genesis-lab`). Pour déployer :
...
2. Sélectionne ton projet `genesis-lab`
...
### ✅ Étape 4 : Ajouter le Domaine stryvlab.com
...
1. **Teste l'accès :** Va sur `https://stryvlab.com`
...
- Vérifie que les DNS sont bien configurés (utilise `dig stryvlab.com` ou [dnschecker.org](https://dnschecker.org))
...
- Vérifie que le webhook pointe vers `https://stryvlab.com/api/stripe/webhook`
...
- [ ] `NEXT_PUBLIC_APP_URL=https://stryvlab.com`
- [ ] Domaine `stryvlab.com` ajouté et validé dans Vercel
...
Une fois tout cela fait, ton site localhost sera accessible sur **stryvlab.com** ! 🎉
