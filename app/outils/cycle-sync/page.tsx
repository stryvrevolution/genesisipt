...
import CycleSyncCalculator from './CycleSyncCalculator'; // Import du fichier client
import GenesisAssistant from '@/components/GenesisAssistant'; // Import de l'assistant

export const metadata: Metadata = {
  title: 'Calculateur Cycle Sync & Nutrition Hormonale | STRYV LAB',
  description: 'Synchronisez votre nutrition et votre entraînement avec votre cycle menstruel.',
  openGraph: {
    images: ['/og-cycle-sync.png'],
  },
};
...
export default function CycleSyncPage() {
  ...
  <span className="text-white/40">Sync</span>
            ...
            <div className="space-y-6 border-t border-white/5 pt-6">
              <div>
                ...
                <p className="text-white/50 text-[13px] leading-relaxed font-light">
                  Protocole d'entraînement et nutrition synchronisé avec les 4 phases du cycle menstruel.
                </p>
              </div>
              <div className="text-white/50 text-[13px] leading-relaxed font-light space-y-3">
                ...
                <div className="space-y-2 pl-4 border-l-2 border-purple-500/30">
                  <p><strong className="text-white/70">• Phase Folliculaire (J1-14)</strong> : Œstrogène ↑↑. Sensibilité insuline maximale, force pic.</p>
                  <p><strong className="text-white/70">• Ovulation (J14-15)</strong> : Pic LH/FSH. Anabolisme optimal 24-48h.</p>
                  <p><strong className="text-white/70">• Phase Lutéale (J15-28)</strong> : Progestérone ↑. Métabolisme +5-10%.</p>
                  <p><strong className="text-white/70">• Menstruation (J1-5)</strong> : Hormones nadir. Inflammation ↑, fatigue.</p>
                </div>
                <p className="pt-2"><strong className="text-white/90">Ajustements training/nutrition</strong> : Volume ±30%, Glucides ±40%.</p>
                <p className="text-[11px] text-white/40 pt-3 border-t border-white/5">Références : Davidsen (2007) • Janse de Jonge (2003)</p>
              </div>
            </div>
          </div>
      ...
      {/* L'assistant est ici, hors du flux principal pour éviter les bugs d'affichage */}
      <GenesisAssistant />
    </>
  );
}